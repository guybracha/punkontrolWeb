...
/**
 * כפתור שיתוף קטן עם תפריט dropdown
 * לשימוש בכרטיסים (ArtworkCard, PostCard)
 */
export default function ShareButton({ url, title, description }) {
  ...
  return (
    <div className="share-button-dropdown position-relative">
      <button
      ...
      {showMenu && (
        <>
          ...
          />
          <div className="share-menu card shadow-lg" onClick={(e) => e.stopPropagation()}>
            <div className="card-body p-2">
              ...
              <button 
                className="dropdown-item d-flex align-items-center gap-2 rounded"
                onClick={(e) => { e.preventDefault(); e.stopPropagation(); handleShare('x'); }}
              >
              ...
              <button 
                className="dropdown-item d-flex align-items-center gap-2 rounded"
                onClick={(e) => { e.preventDefault(); e.stopPropagation(); handleShare('whatsapp'); }}
              >
